...
egen sommetotale = sum(indice) 
ta sommetotale [iw=FQweight]
gen indice_autonomisation = (sommetotale/effectif_total)
ta indice_autonomisation [iw=FQweight]
/* l'indice d'autonomisation globale est*/ ta indice_autonomisation [iw=FQweight]
...
/* Continuation */
gen continue = cond((fp_ever_use==1 & cp ==1),1,0)
...
/*Continuation de la contraception à 12 mois */
